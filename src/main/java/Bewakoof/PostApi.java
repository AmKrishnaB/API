...
public class PostApi {
    public static void applyCoupon(String couponCode){
        ...
        String successMessage = responseBodyPath.getString("carts.deduction."+couponCode+".success_message");

        try {
            if (successMessage.equalsIgnoreCase("Coupon Applied Successfully")) {
                CsvWriter.writeToCSV("C:/Users/Administrator/Downloads/ValidCode.csv", couponCode);
            }
